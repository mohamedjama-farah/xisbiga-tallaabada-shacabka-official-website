...
const FAQS = [
  ...
  { en: { q: 'Can diaspora Somalis vote?', a: 'XTS is pushing for diaspora voting rights. Currently, you must be physically present in Somalia to vote. We are working to change this.' }, so: { q: 'Masakinta Soomaaliyeed ma codeeyn karaan?', a: 'XTS waxay u diriraysaa xuquuqda codeynta masakinta. Hadda, waa inaad jidhkaaga ku joogto Soomaaliya si aad u codeeyso. Waxaan u shaqaynaa in tan la beddelo.' } },
